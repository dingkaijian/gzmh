...
<html lang="zh">
    ...
    <body>
        <form class="layui-form layui-bg-cyan" id="form" name="form" method="post" action="${ctx}/login">
                ...
                <div class="layui-form-item" id="mobilecodediv">
                    ...
                    <div class="layui-input-block" style="font-size: 0;">
                        <input
                            ...
                            style="width: 290px; display: inline-block; font-size: 14px; vertical-align: middle;"
                        />
                        <input style="width:92px;padding:3px 3px;height:36px;" type="button" id="Submit3" name="Submit3" value="获取验证码" onclick="sendCode()"  title="点击发送验证码"/>
                        <span id="codetip" style="float:none;"></span>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div
