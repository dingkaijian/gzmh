 ...
 */
@Service
public class GzLoginRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		logger.debug("=======工作门户Realm=======");
		System.out.println("=======工作门户Realm=======");
		System.out.println("==============AuthenticationToken:"+authcToken);
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		UserAuth user = UserAuthUtils.getByLoginName(principal.getLoginName());	
		if (user != null) {
			...
			// 记录登录日志
			//新日志添加 20190731
			//LogUtils.saveLog(null, null, null, null, "R", "1", user.getLogin()+"登录成功", user.getLogin(), user.getName(), Servlets.getRequest(), null);
			return info;
		} else {
