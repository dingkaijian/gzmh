...
import cn.ac.ict.modules.sys.utils.UserUtils;*/
...
//		}
		...
		String loginType = loginService.getLoginType(userOriginRequestUrl);
		if(StringUtils.isNotEmpty(userOriginRequestUrl)&&userOriginRequestUrl.indexOf("client_id") > 0 || userOriginRequestUrl.indexOf("authorize")>0 ){
...
//		view += ".jsp";
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		Principal principal = UserUtils.getPrincipal();
		System.out.println("=================logincontroller:principal:"+principal.getLoginName());
		// 登录成功后，验证码计算器清零
