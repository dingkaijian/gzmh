...
public class SystemService extends BaseService implements InitializingBean {
	...
	public UserAuth getUserAuthByLoginName(String loginName) {
		return UserAuthUtils.getByLoginName(loginName);
	}
	/**
	 * 获取策略开关
	 * @return
	 */
	public String getSwitch(String configName){
		return userDao.getSeitchByConfigName(configName);
	}
